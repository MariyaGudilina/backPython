...
class AddView(DetailView, FormView):
    model = Post
...
class ProfilePostDetailsView(DetailView):
    model = Post
...
class AddUpdateView(LoginRequiredMixin, UpdateView):
    model = Post
    form_class = PostForm
...
class AddDeleteView(LoginRequiredMixin, DeleteView):
    model = Post
